...
if(isset($_POST["tx"])  and $csrfCheck == TRUE){
    ...
    if($validate === true) {
        ...
        $db->Query("UPDATE db_conabrul SET contacts = '".$db->RealEscape($page_content)."' WHERE id = '1'");
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4><?php echo $lang['contacts']['title']; ?></h4>
            </div>
            <div class="card-body">
                <?php
                if($showError){
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tx" class="form-control" rows="10"><?php echo $data["contacts"]; ?></textarea>
                    </div>
